...
public class Main {
    ...
    private static Map<Integer, Location> locations = new HashMap<>();      // "key" is Integer,
                                                                            // "value" is an object of Location class
    public static void main(String[] args) {
        ...
        while(true) {
            ...
            Map<String, Integer> exits = locations.get(loc).getExits();         // getExits() only returns a copy of the map
